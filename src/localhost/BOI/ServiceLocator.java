...
public class ServiceLocator extends org.apache.axis.client.Service implements localhost.BOI.Service {
 ...
 */
    ...
    private java.lang.String ServiceSoap_address = "http://172.18.67.24:9101/GAMC/esb/service";
    ...
    public localhost.BOI.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public localhost.BOI.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.BOI.ServiceSoapStub _stub = new localhost.BOI.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.BOI.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.BOI.ServiceSoapStub _stub = new localhost.BOI.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost/BOI/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost/BOI/", "ServiceSoap"));
        }
